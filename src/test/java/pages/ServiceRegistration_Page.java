...
public class ServiceRegistration_Page {
    ...
    public void succesAlert() throws InterruptedException {
        ...
        org.junit.Assert.assertEquals("Tamam", bilgilerKydedildi.getText());
    ...
    public void alertSeen() {
        org.junit.Assert.assertTrue(warningPopUpTCID.isDisplayed());
    }
    ...
    public void failAlert() {
        org.junit.Assert.assertNotEquals("Tamam", bilgilerKydedildi.getText());
    }
    ...
    @FindBy(xpath = "(//a[@class='LookupSelectButton text_btn text_btn_ok backWhite'])[34]")
    WebElement dermaPol1_select;

    @FindBy(xpath = "(//a[@class='LookupSelectButton text_btn text_btn_ok backWhite'])[27]")
    WebElement dahiliyePol1_select;

    @FindBy(xpath = "(//a[@class='LookupSelectButton text_btn text_btn_ok backWhite'])[55]")
    WebElement fizikPol1_select;
    ...
    public void clickOnReportsButton() {
        ReusableMethods.jseWithClick(Driver.getDriver(), reports_button);
    ...
    public void assertTheAddressOfRelationship() {
        System.out.println(yakinAdres_box.getAttribute("value"));
    ...
    public void assertTheDescriptionInComplaintBox(String arg0) {
        System.out.println(complaint_box.getAttribute("value"));
